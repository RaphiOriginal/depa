...
public class ComponentsFX implements Components {
	...
	public static class ButtonFX extends javafx.scene.control.Button implements
			Components.Button {
	...
	public static class LabelFX extends javafx.scene.control.Label implements
			Components.Label {
